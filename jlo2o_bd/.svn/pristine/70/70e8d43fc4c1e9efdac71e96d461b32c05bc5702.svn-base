...
public class Oper_FWSGL extends JLBill{
	...
	public Map<String, Object> updateFWSGLXX(String jsonData) throws Exception{
		...
		public Map<String, Object> queryWarehouse() throws Exception{
			Map resultMap = new HashMap();
			String querySql = "select DISTINCT b.zcxx02, b.zcxx01 from ck a LEFT JOIN w_zcxx b on a.gsxx01=b.zcxx01 where a.ck09='0' and a.type=1  and b.zcxx01 is not null ORDER BY b.zcxx01";
			List list = queryForList(o2o, querySql);
