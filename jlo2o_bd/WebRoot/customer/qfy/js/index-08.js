...
if (city_list == null){
		$.getScript('http://int.dpool.sina.com.cn/iplookup/iplookup.php?format=js&ip=',function(){
			...
			if (a > 0){
				var url="/MapService/selectCity.action?city="+province;
				var data=visitService(url);
				if (data.STATE == "1"){
					yn = false;
					provinceId = data.dqbzm01;
					provinceName = data.dqbzm02;
					CityName =data.dqbzm002;
					CityId = data.dqbzm001;
				}
			}
			searchCity();
		});
...
function searchCity(){
	if(a>0){
		if (provinceName != ""){
			city_list = [];
			var o = {};
			o.city_value = provinceId;
			o.city_name = provinceName;
			o.city_value_2 = CityId;
			o.city_name_2 = CityName;
			city_list.push(o);
	...
	/*else if(city_list!=null && a>0){
			city_list = $.parseJSON(city_list);
		if (provinceName != city_list[0].city_name){
			city_list = [];
			var o = {};
			o.city_value = provinceId;
			o.city_name = provinceName;
